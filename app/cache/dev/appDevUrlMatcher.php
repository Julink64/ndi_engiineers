...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::accueilAction',  '_route' => 'PwebMain_accueil',);
        }

        // PwebMain_cv
        if ($pathinfo === '/formulaire') {
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::cvAction',  '_route' => 'PwebMain_cv',);
        }
        ...
        if (0 === strpos($pathinfo, '/projet')) {
            ...
            if (rtrim($pathinfo, '/') === '/projet') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'PwebMain_voirtout');
                }

                return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::voirtoutAction',  '_route' => 'PwebMain_voirtout',);
            }

        }

        // PwebMain_gererprojet
        if (rtrim($pathinfo, '/') === '/gererprojet') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'PwebMain_gererprojet');
            }

            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::gererprojetAction',  '_route' => 'PwebMain_gererprojet',);
        }

        // PwebMain_lierimages
        if (0 === strpos($pathinfo, '/lierimages') && preg_match('#^/lierimages/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'PwebMain_lierimages')), array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::lierimagesAction',));
        }
        ...
        // PwebMain_ajouterimage
        if ($pathinfo === '/ajouterimage') {
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::ajouterimageAction',  '_route' => 'PwebMain_ajouterimage',);
        }

        // PwebMain_voirimage
        if (rtrim($pathinfo, '/') === '/voirimage') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'PwebMain_voirimage');
            }

            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::voirimageAction',  '_route' => 'PwebMain_voirimage',);
        }

        // PwebMain_supprimerimage
        if (0 === strpos($pathinfo, '/supprimerimage') && preg_match('#^/supprimerimage/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'PwebMain_supprimerimage')), array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::supprimerimageAction',));
        }

        // PwebMain_espaceadmin
        if ($pathinfo === '/espaceadmin') {
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::espaceadminAction',  '_route' => 'PwebMain_espaceadmin',);
        }
        ...
        if ($pathinfo === '/statistiques') {
            return array (  '_controller' => 'Pweb\\MainBundle\\Controller\\MainController::statistiquesAction',  '_route' => 'PwebMain_statistiques',);
        }
